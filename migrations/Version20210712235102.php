 ...
 */
final class Version20210712235102 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE vat (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, brand_id INTEGER NOT NULL, rate DOUBLE PRECISION NOT NULL)');
        $this->addSql('CREATE INDEX IDX_84B3223344F5D008 ON vat (brand_id)');
        $this->addSql('DROP INDEX UNIQ_1C52F9587A23D5E1');
        $this->addSql('CREATE TEMPORARY TABLE __temp__brand AS SELECT id, shipping_fees_id, title FROM brand');
        ...
        $this->addSql('INSERT INTO brand (id, shipping_fees_id, title) SELECT id, shipping_fees_id, title FROM __temp__brand');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__brand AS SELECT id, shipping_fees_id, title FROM brand');
        $this->addSql('DROP TABLE brand');
        $this->addSql('CREATE TABLE brand (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, shipping_fees_id INTEGER NOT NULL, title VARCHAR(255) NOT NULL)');
        $this->addSql('INSERT INTO brand (id, shipping_fees_id, title) SELECT id, shipping_fees_id, title FROM __temp__brand');
        $this->addSql('DROP TABLE __temp__brand');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_1C52F9587A23D5E1 ON brand (shipping_fees_id)');
        $this->addSql('DROP INDEX UNIQ_1F1B251E4584665A');
